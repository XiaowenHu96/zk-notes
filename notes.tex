...
Given domain over the generator $D=\{1, \ldots, \omega^{N-1}\}$ and two
...
And if verifier chooses to perform opening on $i\in D$, then the complexity is
the same as for the verifier to compute $r$ by itself.
