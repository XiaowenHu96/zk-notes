...
For paring purpose, where operator $\times$ is addition on elliptic curve over finite
field, we can conclude :
\begin{description}
...
\begin{enumerate}
    ...
    \item Prove and verifier share $pk = \tau^iG_1$ and $vk = \tau G_2$
